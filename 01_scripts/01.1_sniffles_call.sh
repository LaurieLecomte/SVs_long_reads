...
bcftools filter -i 'FILTER="PASS" & PRECISE=1 & SVTYPE!="BND" & SVTYPE!="INVDUP" & SUPPORT > 0' $CALLS_DIR/sniffles/$SAMPLE/"$SAMPLE".vcf > $CALLS_DIR/sniffles/"$SAMPLE"_PASS_PRECISE.vcf