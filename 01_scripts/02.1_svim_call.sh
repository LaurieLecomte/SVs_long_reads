...
# 4. Filter for PASS and PRECISE calls, remove BNDs and SVs supported by less than 1 reads
bcftools filter -i 'FILTER="PASS" & SVTYPE!="BND" & SUPPORT > 0' $CALLS_DIR/svim/$SAMPLE/"$SAMPLE".vcf > $CALLS_DIR/svim/$SAMPLE/"$SAMPLE"_PASS.vcf
