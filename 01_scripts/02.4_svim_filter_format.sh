...
bcftools filter -i 'FILTER="PASS" & SVTYPE!="BND"' $MERGED_DIR/svim/svim_PASS_RSUPP2_refined.vcf | bcftools annotate -x ^INFO/SVTYPE,INFO/SVLEN,INFO/END,INFO/OLDTYPE | bcftools sort > $FILT_DIR/svim/svim_PASS_RSUPP2.vcf
