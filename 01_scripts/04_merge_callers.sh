...
# valeria
# srun -c 10 -p ibis_medium --time=3-00:00:00 --mem=100G -J 04_merge_callers -o log/04_merge_callers_%j.log /bin/sh 01_scripts/04_merge_callers.sh &

# manitou
# srun -c 10 -p medium --time=3-00:00:00 --mem=100G -J 04_merge_callers -o log/04_merge_callers_%j.log /bin/sh 01_scripts/04_merge_callers.sh &
